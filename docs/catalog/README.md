...
| --- | --- | --- | --- |
| AGENTS.md Scribe | core | Author and maintain the root `AGENTS.md` substrate, including the 12 coding rules it carries. | [agent-factory/roles/agents-md-scribe.md](../../agent-factory/roles/agents-md-scribe.md) |
| Architect/Design | core | Make the structure and boundaries the work is built on. | [agent-factory/roles/architect-design.md](../../agent-factory/roles/architect-design.md) |
