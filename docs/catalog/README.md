...
| Software Engineer | core | Implement one ticket — pull the shared context first, make a small diff, add tests, run checks, and update docs. | [agent-factory/roles/software-engineer.md](../../agent-factory/roles/software-engineer.md) |
