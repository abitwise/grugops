...
const { CHECKPOINT_DEFAULTS, CONFIG_REFUSAL_PREFIX, FLOOR_CHECKPOINTS, NAMED_GRANT_ENV_VARS, GRANT_ENV_VAR_PATTERN_SOURCE, PROD_DEPLOY_APPROVAL_ENV_VAR, composeBanner, evaluateMatrix, floorEnvVarName, grantedBy, isGrantEnvVarName, } = cpMod;
...
const SELF_APPROVE = new RegExp(`(?:^|[\\s;&|(])(?:export\\s+|env\\s+)?(${GRANT_ENV_VAR_PATTERN_SOURCE})\\s*=`);
