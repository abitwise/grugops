...
export function isFileFollowing(p: string): boolean {
  try {
...
export function isDirFollowing(p: string): boolean {
  try {
...
export function srcSkillNames(srcRoot: string): string[] | null {
...
export function srcAdapterFiles(srcRoot: string): string[] | null {
...
export function srcNestedAdapterFiles(srcRoot: string): string[] {
  ...
  const walk = (base: string): string[] => {
    ...
    for (const name of names) {
      ...
      if (isDirFollowing(full)) out.push(...walk(rel));
