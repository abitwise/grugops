...
- [x] **Phase 23: Parallel Execution & Orchestrator-as-Decomposer** — Orchestrator router→decomposer/scheduler/gate, nested CC spawning + the degraded sequential path, the inverted WR-05 guard, the WIP cap (Workflow 17) (all 3 plans executed 2026-06-21 — awaiting phase verification; 23-03 inverted guard_wr05 closed on RED-baseline + GREEN-proof + independent probe vs the committed .js)
