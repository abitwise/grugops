...
| `r05-cr01-nul` | 5 | CR-01 | `no-opening-delimiter` | line 1 of the fence-stripped document is ` --- `, and the canonical form requires it to be exactly `---`; a byte-order mark, leading whitespace or a directive before the delimiter is refused rather than skipped | UNKNOWN - verify |
