...
- **Requirement `DASH-02` IS marked complete here, and the readiness was checked rather than assumed.** `DASH-02` is declared by exactly three plans — 32-01, 32-02 and 32-04 — and all three now have summaries, so `requirements.ready-ids` reports 1 of 1 ready. That is unlike plan 32-01, whose five IDs were all still held by unfinished siblings.
