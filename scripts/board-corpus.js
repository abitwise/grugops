 ...
 */
export const BOARD_CORPUS_SOURCES = [
    CHESS,
    DOGFOOD,
    SPEC,
    EX02,
 ...
 */
export function frameDocument(row) {
...
if (BOARD_CORPUS.length !== BOARD_CORPUS_COUNT) {
    throw new Error(`board-corpus: BOARD_CORPUS_COUNT is ${BOARD_CORPUS_COUNT} and the corpus holds ${BOARD_CORPUS.length} row(s). ` +
 ...
 */
export function unresolvedSources(root) {
