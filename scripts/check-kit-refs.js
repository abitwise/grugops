...
function isConfigSibling(siblings, base) {
...
const { exempt, exemptMentions, strays, files: exemptFiles, } = exemptConfigSelfRefs(grepSubstring(SCAN, CONFIG_REF_NEEDLE), configSiblings);
