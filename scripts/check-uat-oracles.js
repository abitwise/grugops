...
import { appendNote, emitVerdict } from "./context-io.js";
...
function equivDoWork(sub, task) {
    ...
    emitVerdict(task, FIXED_ID, "clean", FROZEN_GATE_SHA, sub.contextRoot, `2026-06-21T10:${String(n).padStart(2, "0")}:15.000Z`);
    const soft = {
        kind: "observation",
        by: "engineer",
