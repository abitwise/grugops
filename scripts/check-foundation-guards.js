...
// honors.
import { listRoles, listWorkflows, listAgentAdapters, listSkillAdapters, listPluginSkillAdapters, listPluginDefaultComponentFiles, listPluginExemptComponentFiles, pluginForbiddenComponentKeys, spawnGrantScan, spawnGrantScanPrefix, SPAWN_GRANT_SCAN_PARTS, PLUGIN_MANIFEST_COMPONENT_SCHEMA, PLUGIN_MANIFEST_COMPONENT_COUNT, PLUGIN_COMPONENT_COVERED_ELSEWHERE, PLUGIN_COMPONENT_EXEMPT, ROLE_COUNT, WORKFLOW_COUNT, SKILL_ADAPTER_COUNT, PLUGIN_SKILL_ADAPTER_COUNT, SPAWN_GRANT_SCAN_COUNT, } from "./kit-model.js";
...
function guardKitCounts() {
    ...
    const doubleClaimedKeys = schemaKeys.filter((k) => claimedKeys.filter((c) => c === k).length > 1);
