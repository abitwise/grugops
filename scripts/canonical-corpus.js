...
export const CORPUS = [
    // ── ROUND 1 — 27-REVIEW-GAPS.md § CR-01: a YAML anchor/alias grant read as no grant ───────────
    {
        ...
        finding: "CR-01",
        source: R01,
        sourceDetail: "§ CR-01, the parse transcript printed against the committed frontmatter.js",
        kind: "bypass",
        reproducedAt: "module",
        label: "an alias on the tools key, its anchor parked under a helper key — the founding silent no-grant",
        ...
        loaderVerdict: null,
        loaderNote: "UNKNOWN - verify: round 1 ran no YAML loader; the review argues from the YAML 1.1/1.2 spec that any compliant parser resolves `tools: *t` to the granting value, and records no measured loader transcript.",
    },
    {
        id: "r01-cr01-gate",
        round: 1,
        finding: "CR-01",
        source: R01,
        sourceDetail: "§ CR-01, the hermetic-mirror plant on .claude/skills/grugops-gate/SKILL.md, gate ALL CHECKS PASSED",
        kind: "bypass",
        reproducedAt: "gate",
        label: "the same alias planted on a live skill adapter's allowed-tools key — whole gate green",
        transcription: "framed",
        text: doc([
            "name: grugops-gate",
        ...
        expected: "node-property",
        loaderVerdict: null,
        loaderNote: "UNKNOWN - verify: no loader was run in round 1. The review's own `description:` line trails off in an ellipsis; the elision is dropped here rather than invented.",
    },
    // ── ROUND 2 — 27-REVIEW-GAPS-2.md § CR-01: a tag prefix hides the anchor ──────────────────────
    {
        ...
        finding: "CR-01",
        source: R02,
        sourceDetail: "§ CR-01, the two-line reproduction and the mirror plant on .claude/skills/grugops-map/SKILL.md",
        kind: "bypass",
        reproducedAt: "module+gate",
        label: "a shorthand tag standing in front of the anchor, and a tagged flow collection carrying the alias",
        transcription: "framed",
        text: doc([
            "name: r",
        ...
        expected: "node-property",
        loaderVerdict: null,
        loaderNote: "UNKNOWN - verify: round 2 ran no loader either; it records the gate exit code and argues the resolution from the spec.",
    },
    // ── ROUND 3 — 27-REVIEW-GAPS-3.md § CR-01: unquote() mangles YAML escapes ─────────────────────
    {
        ...
        finding: "CR-01",
        source: R03,
        sourceDetail: "§ CR-01, the plant on .claude/skills/grugops-map/SKILL.md, gate ALL CHECKS PASSED at exit 0",
        kind: "bypass",
        reproducedAt: "module+gate",
        label: "an 8-bit numeric escape spelling the grant token inside a quoted block-sequence item",
        transcription: "framed",
        text: doc([
            "name: r",
            "allowed-tools:",
        ...
        loaderVerdict: null,
        loaderNote: "UNKNOWN - verify: the round-3 review states in its own words that no third-party YAML loader was executable in that environment, and rests the finding on YAML 1.2 § 5.7 instead.",
    },
    {
        ...
        kind: "bypass",
        reproducedAt: "module",
        label: "a %TAG directive before the opening delimiter takes the `no frontmatter at all` success arm",
        transcription: "verbatim",
        text: headed("%TAG !e! tag:x,2000:", ["---", "name: x", "tools: Read, Agent(o)"]),
        expected: "no-opening-delimiter",
        loaderVerdict: null,
        loaderNote: "UNKNOWN - verify: the review states the platform probably sees no frontmatter either and explicitly declines to confirm it against Claude Code.",
    },
    // ── ROUND 4 — 27-REVIEW-GAPS-4.md § CR-01: a byte adjoining the delimiter ─────────────────────
    {
        ...
        finding: "CR-01",
        source: R04,
        sourceDetail: "§ CR-01, the parser reproduction and the byte-level gate control (WITH BOM exit 0 / WITHOUT BOM exit 1)",
        kind: "bypass",
        reproducedAt: "module+gate",
        label: "a three-byte UTF-8 BOM in front of the opening delimiter, the only difference from a red gate",
        transcription: "verbatim",
        text: BOM + doc(["name: rogue", `tools: Read, ${GRANT}`]),
        expected: "no-opening-delimiter",
        loaderVerdict: null,
        loaderNote: "UNKNOWN - verify: round 4 measured the module and the gate; it records no loader transcript for the prologue rows.",
    },
    {
        ...
        finding: "CR-01",
        source: R04,
        sourceDetail: "§ CR-01, the second independent member of the complement, reproduced identically at exit 0",
        kind: "bypass",
        reproducedAt: "gate",
        label: "a NO-BREAK SPACE after the opening delimiter — a different byte, the same silent success arm",
        transcription: "framed",
        text: headed(`---${NBSP}`, ["name: rogue", `tools: Read, ${GRANT}`]),
        expected: "no-opening-delimiter",
        loaderVerdict: null,
        loaderNote: "UNKNOWN - verify: recorded by gate exit code only; no loader transcript in round 4.",
    },
    ...
    // single row cannot show a composition.
    {
        ...
        expected: "no-opening-delimiter",
        loaderVerdict: null,
        loaderNote: "UNKNOWN - verify: the review records the module verdict and the gate exit code, and explicitly declines to claim Claude Code loads such a head line.",
    },
    {
    ...
    },
    {
        ...
        kind: "bypass",
        reproducedAt: "module",
        label: "an ordinary leading space in front of an illegal payload — the residue need not be invisible",
        transcription: "framed",
    ...
    },
    {
        ...
        kind: "bypass",
        reproducedAt: "module",
        label: "a combining acute accent on both sides of a legal payload — residue with no width of its own",
        transcription: "framed",
    ...
    },
    {
        ...
        kind: "bypass",
        reproducedAt: "module",
        label: "residue on both sides of a legal payload, in two different invisible code points",
        transcription: "framed",
    ...
    },
    {
        ...
        kind: "bypass",
        reproducedAt: "module",
        label: "a NULL byte on both sides of a legal payload — the residue is a C0 control character",
        transcription: "framed",
    ...
    },
    {
        ...
        finding: "CR-01",
        source: R05,
        sourceDetail: "§ CR-01, the gate-level table: `---<ZWSP>` exit 1, `<ZWSP>---` exit 1, `<ZWSP>---<ZWSP>` exit 0",
        kind: "bypass",
        reproducedAt: "gate",
        label: "the composite that flips a red gate green — each half refuses alone, the composition does not",
        transcription: "framed",
        text: headed(`${ZWSP}---${ZWSP}`, ["name: rogue", `allowed-tools: Read, ${GRANT}`]),
        expected: "no-opening-delimiter",
        loaderVerdict: null,
        loaderNote: "UNKNOWN - verify: the review records the gate exit codes and states the platform load question as its own open UNKNOWN.",
    },
    // ── ROUND 6 — 27-REVIEW-GAPS-6.md § CR-01: quote state decided per PHYSICAL LINE ──────────────
    {
        ...
        kind: "bypass",
        reproducedAt: "module",
        label: "a double-quoted scalar wrapping across lines, whose continuation begins with a comment sigil",
        transcription: "verbatim",
        text: doc(["name: rogue", 'tools: "Read,', `  # x, ${GRANT}"`]),
        expected: "quoted-on-plain-only-key",
        loaderVerdict: `{"tools"=>"Read, # x, Agent(grugops-orchestrator)"}`,
        loaderNote: "Recorded in round 6 from `ruby -ryaml` on the same bytes; the loader sees the grant.",
    },
    {
        ...
        loaderVerdict: `{"tools"=>"Read, # x, Agent(grugops-orchestrator)"}`,
        loaderNote: "The review states spelling B is identical to spelling A with the quote style swapped, and records the same loader value.",
    },
    {
        ...
        finding: "CR-01",
        source: R06,
        sourceDetail: "§ CR-01, spelling C — the idiom all 7 shipped skills and all 17 agent adapters use; reproduced end to end",
        kind: "bypass",
        reproducedAt: "module+gate",
        label: "the wrap inside a quoted block-sequence item, which is the shape a drifting author would write",
        transcription: "framed",
        text: doc([
            "name: r",
            "allowed-tools:",
        ...
        loaderNote: "Round 6 records this `ruby -ryaml` transcript for spelling C on the two-item form; the planted file carries the same construct with the kit's five baseline tools ahead of it.",
    },
    ...
    },
    {
        ...
        finding: "CR-01",
        source: R07,
        sourceDetail: "§ CR-01, end-to-end reproduction (a): skills/plan/SKILL.md + .claude/skills/grugops-plan/SKILL.md, exit 0",
        kind: "bypass",
        reproducedAt: "gate",
        label: "the wrapped scalar planted into a live allowed-tools key on both distribution twins",
        transcription: "framed",
        text: doc([
            "name: r",
            "allowed-tools:",
    ...
    },
    {
        ...
        finding: "CR-01",
        source: R07,
        sourceDetail: "§ CR-01, end-to-end reproduction (c): the non-coordinator role agent .claude/agents/grugops-qe-e2e.md, exit 0",
        kind: "bypass",
        reproducedAt: "gate",
        label: "the same construct on an AGENT adapter's tools key, past the structure validator as well",
        transcription: "framed",
        text: doc([
            "name: r",
            "tools:",
    ...
    // ── ROUND 8 — 27-REVIEW-GAPS-8.md § CR-01: the walk's node-start set is not YAML's ────────────
    {
        ...
        loaderNote: "Round 8 measured every row against /usr/bin/ruby -ryaml (ruby 2.6.10 / psych 3.1.0 / libyaml 0.2.1).",
    },
    {
    ...
    },
    {
        ...
        kind: "bypass",
        reproducedAt: "module+gate",
        label: "JSON-like colon adjacency inside a flow mapping, one character away from a pinned sibling",
        transcription: "framed",
        text: doc(["name: r", 'tools: {"a":"Read,', `  # x, ${GRANT}"}`]),
        expected: "flow-collection",
        loaderVerdict: `{"a"=>"Read, # x, Agent(grugops-orchestrator)"}`,
    ...
    // ── ROUND 9 — 27-REVIEW-round9.md § CR-01: YAML's `''` escape destroys a scalar's provenance ──
    {
        ...
        loaderNote: "Round 9 recorded verbatim /usr/bin/ruby -ryaml transcripts; every row is libyaml-ACCEPTED with the grant in the loaded value.",
    },
    {
    ...
    },
    {
        ...
        kind: "control",
        reproducedAt: "module",
        label: "the same wrap with the `''` removed, which the old module read CORRECTLY as a grant",
        transcription: "framed",
        text: doc(["name: r", "tools: 'Read,", `  # x, ${GRANT}'`]),
        expected: "single-quoted",
        loaderVerdict: `"Read, # x, Agent(grugops-orchestrator)"`,
        loaderNote: "Round 9 records this row as the control that isolates the `''`: the old module returned {ok:true,value:true} here, correctly.",
    },
    {
        id: "r09-cr01-gate",
        round: 9,
        finding: "CR-01",
        source: R09,
        sourceDetail: "§ CR-01, the hermetic-mirror gate transcript on skills/plan/SKILL.md, ALL CHECKS PASSED at EXIT=0",
        kind: "bypass",
        reproducedAt: "gate",
        ...
        expected: "single-quoted",
        loaderVerdict: `"Read' s, # x, Agent(grugops-orchestrator)"`,
        loaderNote: "Round 9's gate transcript prints the loader value for the planted file alongside the module's parse.",
    },
    // ── ROUND 10 — 27-REVIEW-round10.md ───────────────────────────────────────────────────────────
    {
        ...
        source: R10,
        sourceDetail: "§ CR-01, row U1 — a regression introduced by round 10's own fix (`sawBlock` is sticky)",
        kind: "bypass",
        reproducedAt: "module",
        label: "one unrelated sibling entry carrying a block scalar disables the escape refusal for the whole key",
        transcription: "verbatim",
        text: doc([
            "name: r",
            "tools:",
    ...
    },
    {
        ...
        kind: "control",
        reproducedAt: "module",
        label: "the same escaped grant with the sibling removed, which the old module REFUSED correctly",
        transcription: "verbatim",
        text: doc(["name: r", "tools:", `  a: "${BS}x41gent(grugops-orchestrator)"`]),
        expected: "unrecognized-line",
        loaderVerdict: `{"a"=>"Agent(grugops-orchestrator)"}`,
        loaderNote: "Round 10 records U2's libyaml value and states that U2 alone passes and proves nothing — the defect is that U2's own refusal disappears when a sibling is added.",
    },
    {
    ...
    },
    {
        ...
        kind: "control",
        reproducedAt: "module",
        label: "the same property at offset 0 of the line, which the old module refused — the proof this was the introduction set and not the sigil test",
        transcription: "framed",
        text: doc(["name: r", "tools:", "  &a >-", `    Read, # x, ${GRANT}`]),
        expected: "node-property",
        loaderVerdict: null,
        loaderNote: "UNKNOWN - verify: round 10 records row P's MODULE verdict (a correct refusal) and does not print a libyaml column for it.",
    },
    {
        id: "r10-cr02-gate",
        round: 10,
        finding: "CR-02",
        source: R10,
        sourceDetail: "§ CR-02, the gate-level reproduction planted on .claude/skills/grugops-map/SKILL.md and skills/map/SKILL.md, exit 0",
        kind: "bypass",
        reproducedAt: "gate",
    ...
    },
    {
        ...
        kind: "divergence",
        reproducedAt: "module",
        label: "a more-indented first content line made the old module report a grant the loader does not have",
        transcription: "verbatim",
        text: doc([
            "name: r",
            "tools:",
        ...
        loaderNote: "Round 10 records the libyaml value; this is the OPPOSITE direction to a silent no-grant and is recorded as a divergence, never counted as a bypass.",
    },
    {
        ...
        kind: "divergence",
        reproducedAt: "module",
        label: "a folded scalar's blank line, dropped and space-joined, made the old module INVENT an enumerated name",
        transcription: "verbatim",
        text: doc(["name: r", "tools: >", "  Agent(alpha, ga", "", "  mma)"]),
        expected: "block-scalar",
        loaderVerdict: `"Agent(alpha, ga\\nmma)\\n"`,
        loaderNote: "Round 10 records the libyaml value; the module enumerated [\"alpha\",\"ga mma\"], one of them invented.",
    },
    ...
    // half of CR-02's asymmetry. Rows A and B of CR-01 are the confirmed regression against `3c7930b`.
    {
        ...
        finding: "CR-01 row A",
        source: R11,
        sourceDetail: "§ CR-01 Row A — the round-11 regression, confirmed against the pre-round build 3c7930b",
        kind: "bypass",
        reproducedAt: "module+gate",
        label: "an explicit-digit folded block header on its own line under a bare dash — the block indentation landmark is the header LINE, not the parent node",
        transcription: "verbatim",
        text: doc([
            "name: r",
            "tools:",
        ...
        loaderNote: "Round 11 records the /usr/bin/ruby -ryaml column: the grant is in the loaded value. HEAD returned {ok:true,value:false}; 3c7930b returned the grant.",
    },
    {
        ...
        expected: "block-scalar",
        loaderVerdict: `["Read, # x, Agent(grugops-orchestrator)"]`,
        loaderNote: "Round 11 loader column for row B. Row B is pre-existing rather than a regression, and survives the round-11 fix at both `>-` and `|-`.",
    },
    {
        id: "r11-cr01-gate-a",
        round: 11,
        ...
        source: R11,
        sourceDetail: "§ CR-01 `Gate reproduction, row A` — planted into the EXISTING allowed-tools key of both twins of the map skill; HEAD exit 0, 3c7930b exit 1",
        kind: "bypass",
        reproducedAt: "gate",
        label: "row A's construct in the exact bytes planted into a live allowed-tools key — the spelling plan 27-65 plants",
        transcription: "verbatim",
        text: doc([
            "name: r",
            "allowed-tools:",
    ...
    },
    {
        ...
        source: R11,
        sourceDetail: "§ CR-01 Row B — `the same shape planted on the same two twins` → ALL CHECKS PASSED, exit 0",
        kind: "bypass",
        reproducedAt: "gate",
        ...
        expected: "block-scalar",
        loaderVerdict: null,
        loaderNote: "UNKNOWN - verify: round 11 records the gate exit code for row B's plant but prints no separate libyaml transcript for the planted spelling; row B's own loader value is recorded at the parser level instead.",
    },
    {
        ...
        finding: "CR-02",
        source: R11,
        sourceDetail: "§ CR-02 Row — a resolvable alias reaching a grant through a sequence item's compact mapping; the loader ACCEPTS this document",
        kind: "bypass",
        reproducedAt: "module+gate",
        label: "D-61's fourth application point was wired into one of the two blockHeaderAt call sites",
        transcription: "verbatim",
        text: doc([
            "name: r",
            "_x:",
        ...
        loaderNote: "Round 11 records the /usr/bin/ruby -ryaml column. The review also records `UNKNOWN - verify` on whether Claude Code honours a MAPPING under allowed-tools as a grant; the finding stands on the module's own contract.",
    },
    {
        ...
        source: R11,
        sourceDetail: "§ CR-02 — `the identical alias one spelling over (`  j: *a`, no dash)`, REFUSED by name on the old module",
        kind: "control",
        reproducedAt: "module",
        label: "the same alias, the same key, the same loader value — refused loudly one dash over, which is the proof this was the call-site set and not the sigil test",
        transcription: "verbatim",
        text: doc(["name: r", "_x:", `  - k: &a ${GRANT}`, "allowed-tools:", "  j: *a"]),
        expected: "node-property",
        loaderVerdict: null,
        loaderNote: "UNKNOWN - verify: round 11 records the control's MODULE verdict (a loud refusal, naming a YAML anchor or alias) and does not print a separate libyaml column for it.",
    },
    {
        id: "r11-cr02-gate",
        round: 11,
        ...
        source: R11,
        sourceDetail: "§ CR-02 `Gate reproduction` — planted on both twins of the non-coordinator map skill, ALL CHECKS PASSED at exit 0",
        kind: "bypass",
        reproducedAt: "gate",
        label: "the alias planted behind the kit's five baseline tools in a live allowed-tools key — the spelling plan 27-65 plants",
        transcription: "verbatim",
        text: doc([
            "name: r",
            "_x:",
    ...
    },
    {
        ...
        source: R11,
        sourceDetail: "§ CR-02 — the loader-REJECTED half of the same gap, whose dash-less twin refuses loudly (27-57-SUMMARY row T3)",
        kind: "bypass",
        reproducedAt: "module",
        label: "an alias in front of a block header inside a sequence item's compact mapping — a document libyaml refuses to load, returned on the SUCCESS arm",
        transcription: "framed",
        text: doc(["name: r", "tools:", "  - k: *a >-"]),
        expected: "node-property",
        loaderVerdict: "REJECTED by libyaml",
        loaderNote: "Round 11 states this half is on documents `libyaml refuses to load`. A loader rejection is still not a clean verdict: the module returned {ok:true,value:false}.",
    },
    {
        ...
        finding: "CR-02 row R",
        source: R11,
        sourceDetail: "§ CR-02 — the second loader-REJECTED spelling, two stacked anchors (27-57-SUMMARY row R)",
        kind: "bypass",
        reproducedAt: "module",
    ...
    // row's `round` comes from the axis's own recorded attribution in its section comment.
    {
        ...
        source: AXIS,
        sourceDetail: "REFUSED_FORMS — `alias in the value position, anchor parked under a second key`, KEY-LINE application point",
        kind: "bypass",
        reproducedAt: "module",
        ...
        expected: "node-property",
        loaderVerdict: null,
        loaderNote: "UNKNOWN - verify: this axis row's serializer is asserted against the module's refusal arm; the axis records no per-row loader transcript (the loader columns in that file live on the WR01_FALSE_RED_FORMS rows and the differential).",
    },
    {
        id: "ax-ref-own-value",
        round: 1,
    ...
    },
    {
        ...
        source: AXIS,
        sourceDetail: "REFUSED_FORMS — `anchor and alias as block-sequence items on continuation lines`, SEQ_ITEM application point",
        kind: "bypass",
        reproducedAt: "module",
    ...
    },
    {
        ...
        source: AXIS,
        sourceDetail: "REFUSED_FORMS, TAG axis — double-indicator shorthand tag in front of the anchor, tagged flow alias on the tools key",
        kind: "bypass",
        reproducedAt: "module",
    ...
    },
    {
        ...
        source: AXIS,
        sourceDetail: "REFUSED_FORMS, TAG axis — `a tag standing directly on the tools key's own value`",
        kind: "bypass",
        reproducedAt: "module",
        label: "an unresolved node property is enough on its own — no anchor, no alias, just a tag on the grant key",
        transcription: "framed",
    ...
    },
    {
        ...
        source: AXIS,
        sourceDetail: "REFUSED_FORMS, TAG axis — `a TAGGED flow collection whose items carry the anchor and the alias`",
        kind: "bypass",
        reproducedAt: "module",
    ...
    },
    {
        ...
        source: AXIS,
        sourceDetail: "REFUSED_FORMS, TAG axis — `tagged anchor and alias as block-sequence items on continuation lines`",
        kind: "bypass",
        reproducedAt: "module",
    ...
    },
    {
        ...
        source: AXIS,
        sourceDetail: "REFUSED_FORMS, TAG axis — `a NAMED-HANDLE tag carrying a second indicator inside the tag`",
        kind: "bypass",
        reproducedAt: "module",
    ...
    },
    {
        ...
        kind: "bypass",
        reproducedAt: "module",
        label: "a verbatim tag may legally contain the flow indicators every other tag form terminates on",
        transcription: "framed",
        text: doc([
            "name: r",
    ...
    },
    {
        ...
        source: AXIS,
        sourceDetail: "REFUSED_FORMS, TAG axis — `the BARE non-specific tag, whose second character is a space`",
        kind: "bypass",
        reproducedAt: "module",
        label: "the sharpest row of that table: invisible to a sigil class alone, because its second byte is a space",
        transcription: "framed",
        text: doc([
            "name: r",
            `_tools: ! &t Read, Write, Bash, Glob, Grep, ${GRANT}`,
    ...
    },
    {
        ...
        source: AXIS,
        sourceDetail: "REFUSED_FORMS, TAG axis — `a shorthand tag butting directly against the collection`",
        kind: "bypass",
        reproducedAt: "module",
    ...
    },
    {
        ...
        source: AXIS,
        sourceDetail: "REFUSED_FORMS, TAG axis — `a tag followed by an ANCHOR which is itself followed by the collection`",
        kind: "bypass",
        reproducedAt: "module",
    ...
    },
    {
        ...
        source: AXIS,
        sourceDetail: "REFUSED_FORMS, TAG axis — `BARE non-specific tags on nodes INSIDE a flow collection`",
        kind: "bypass",
        reproducedAt: "module",
    ...
    },
    {
        ...
        source: AXIS,
        sourceDetail: "ESCAPE_FORMS — `an escaped grant in the tools key's own double-quoted value`",
        kind: "bypass",
        reproducedAt: "module",
        ...
        expected: "quoted-on-plain-only-key",
        loaderVerdict: null,
        loaderNote: "UNKNOWN - verify: the escape axis was derived from round 3, whose review states no loader was executable in that environment.",
    },
    {
        ...
        source: AXIS,
        sourceDetail: "ESCAPE_FORMS — `an escaped value under a helper key aliased nowhere (red for the escape, not for a reference)`",
        kind: "bypass",
        reproducedAt: "module",
    ...
    },
    {
        ...
        source: AXIS,
        sourceDetail: "ESCAPE_FORMS — `an escaped grant as a quoted item inside a flow collection`; one of the two points the first draft of the D-30 fix missed",
        kind: "bypass",
        reproducedAt: "module",
    ...
    },
    {
        ...
        source: AXIS,
        sourceDetail: "ESCAPE_FORMS — `an escaped grant as a quoted block-sequence item on a continuation line`; the shape the aggregator case plants",
        kind: "bypass",
        reproducedAt: "module",
    ...
    },
    {
        ...
        source: AXIS,
        sourceDetail: "ESCAPE_FORMS — `an escaped quoted fragment arriving on a plain continuation line`; the second point the first draft missed",
        kind: "bypass",
        reproducedAt: "module",
        label: "the escaped fragment arrives on the wrapped line, so the joined value is a composite no wrapping-quote strip matches",
        transcription: "framed",
        text: doc([
            "name: r",
            "tools: Read,",
    ...
    },
    {
        ...
        source: AXIS,
        sourceDetail: "ESCAPE_FORMS — `the line-feed escape, which the old rewrite turned into a literal n`",
        kind: "bypass",
        reproducedAt: "module",
    ...
    },
    {
        ...
        source: AXIS,
        sourceDetail: "ESCAPE_FORMS — `a TRUNCATED numeric escape (one hex digit where two are required)`",
        kind: "bypass",
        reproducedAt: "module",
        label: "a short numeric escape, which carries no special case because no hex-digit count is ever counted",
        transcription: "framed",
    ...
    },
    {
        ...
        source: AXIS,
        sourceDetail: "ESCAPE_FORMS — `a DANGLING backslash at the very end of the scalar body`, the bounds-check row",
        kind: "bypass",
        reproducedAt: "module",
        label: "a backslash as the last byte of the scalar body, where an unbounded scanner would read undefined",
        transcription: "framed",
...
if (CORPUS.length !== CORPUS_COUNT) {
    throw new Error(`canonical-corpus: CORPUS_COUNT is ${CORPUS_COUNT} and the corpus holds ${CORPUS.length} row(s). ` +
