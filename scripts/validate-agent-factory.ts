...
const SUPPLIED_STATE_ROOT: string | null = process.env.VALIDATE_ROOT?.trim() || null;
 ...
 */
const governanceBaseContributions: number[] = [];
...
function checkConfig(): void {
  ...
  const kitConfigAbs = resolve(
    join(canonicalBase(KIT_ROOT), "agent-factory", "config", "factory.config.json"),
  );
