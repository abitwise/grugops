 ...
 */
export function insideRoot(root, target, what) {
    let real;
    try {
    ...
    for (const task of claimedNames) {
        ...
        if (atLineCount > 1) {
            errors.push({
                ...
                path: claimMd,
                code: "tampered",
                message: spelled `${claimMd} carries ${atLineCount} \`at:\` lines and a claim record is written with ` +
        ...
        if (at === null) {
            ...
            errors.push({
                ...
                path: claimMd,
                code: "no-at",
                message: spelled `${claimMd} carries no \`at:\` line and a claim record is written with exactly one. ` +
