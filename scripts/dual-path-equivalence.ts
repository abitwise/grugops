...
// The projected fingerprint of one live note — everything that defines equivalence EXCEPT the nonce
// `id` (dropped so two runs of the same seed compare equal — Pitfall 2 / D-04).
